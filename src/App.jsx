  ...
  const toggleMute = () => {
    if (youtubePlayerRef.current) {
      if (isMuted) {
        ...
        youtubePlayerRef.current.setVolume(70);
      } else {
      ...
      <section className="py-16 px-6 relative" style={{ backgroundImage: 'linear-gradient(45deg, #ee9ca7 0%, #ffdde1 100%)' }}>
        <div className="max-w-4xl mx-auto">
          ...
          >
              ...
              <motion.div 
                className="bg-white/90 backdrop-blur-sm rounded-3xl p-4 md:p-6 shadow-2xl relative"
              ...
              >
                <div className="rounded-2xl overflow-hidden shadow-lg aspect-video relative">
                  <iframe
                    ...
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/KQetemT1sWc?enablejsapi=1&autoplay=1&mute=1&loop=1&playlist=KQetemT1sWc&controls=1"
                  ...
                  <motion.button
                    onClick={toggleMute}
                    className="absolute bottom-4 right-4 bg-pink-500 hover:bg-pink-600 text-white rounded-full p-3 md:p-4 shadow-lg z-10 transition-colors"
      ...
      <section className="py-16 px-6" style={{ backgroundImage: 'linear-gradient(45deg, #ee9ca7 0%, #ffdde1 100%)' }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <motion.p 
              className="font-poppins text-sm text-gray-500 mb-4 flex items-center justify-center gap-2"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
